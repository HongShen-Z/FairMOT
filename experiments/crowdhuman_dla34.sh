...
python train.py mot --exp_id ch_dla34_wh_eiou3 --gpus $CUDA_VISIBLE_DEVICES --resume \
--batch_size 32 --load_model '../exp/mot/ch_dla34_wh_eiou2/models/model_155.pth' --num_epochs 255 \

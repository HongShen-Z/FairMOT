...
#--lr_step '800' --lr 5e-6 --data_cfg '../src/lib/cfg/crowdhuman.json' --dense_wh --wh_weight 5.0
python train.py mot --exp_id ch_dla34_wh_eiou2 --gpus $CUDA_VISIBLE_DEVICES --resume \
--batch_size 32 --load_model '../exp/mot/ch_dla34_wh_eiou1/models/model_last.pth' --num_epochs 200 \

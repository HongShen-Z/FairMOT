...
#--batch_size 32 --load_model '../exp/mot/ch_dla34_wh4/models/model_last.pth' --num_epochs 400 \
#--lr_step '800' --lr 1e-5 --data_cfg '../src/lib/cfg/crowdhuman.json' --dense_wh --wh_weight 5.0
python train.py mot --exp_id ch_dla34_wh_feiou --gpus $CUDA_VISIBLE_DEVICES \

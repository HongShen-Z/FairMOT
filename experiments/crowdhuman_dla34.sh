...
conda activate fair
cd src
python train.py mot --exp_id ch_dla34_grad --gpus $CUDA_VISIBLE_DEVICES \
--batch_size 16 --load_model '../models/ctdet_coco_dla_2x.pth' --num_epochs 100 \
--lr_step '200' --lr 1e-4 --data_cfg '../src/lib/cfg/crowdhuman.json'

...
conda activate fair
cd src
python train.py mot --exp_id ch_dla34_wh_eiou02 --gpus $CUDA_VISIBLE_DEVICES --resume \
--batch_size 32 --load_model '../exp/mot/ch_dla34_wh_eiou01/models/model_140.pth' --num_epochs 300 \

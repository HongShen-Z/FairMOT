...
python train.py mot --exp_id ch_dla34_wh_eiou6 --gpus $CUDA_VISIBLE_DEVICES --resume \
--batch_size 32 --load_model '../exp/mot/ch_dla34_wh_eiou5/models/model_265.pth' --num_epochs 400 \
--lr_step '800' --lr 8e-6 --data_cfg '../src/lib/cfg/crowdhuman.json' --dense_wh --wh_weight 5.0
cd ..

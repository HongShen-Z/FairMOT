...
conda activate fair
cd src
#python train.py mot --exp_id ch_dla34_wh_eiou00 --gpus $CUDA_VISIBLE_DEVICES \
...
--batch_size 32 --num_epochs 150 --load_model '../exp/mot/ch_res34_whe/models/model_30.pth' \

...
python train.py mot --exp_id ch_dla34_whe1 --gpus $CUDA_VISIBLE_DEVICES --resume \
--batch_size 32 --load_model '../exp/mot/ch_dla34_whe/models/model_10.pth' --num_epochs 200 \
--lr_step '800' --lr 5e-4 --data_cfg '../src/lib/cfg/crowdhuman.json' --dense_wh --wh_weight 5.0
cd ..

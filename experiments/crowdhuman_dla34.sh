...
conda activate fair
cd src
python train.py mot --exp_id ch_fix_ITP-MMD --gpus $CUDA_VISIBLE_DEVICES --multi_loss 'fix' --alpha 0.25 \
--batch_size 16 --load_model '../models/ctdet_coco_dla_2x.pth' --num_epochs 30 --hm_shape 'oval' \
--lr_step '20' --lr 1e-4 --data_cfg '../src/lib/cfg/crowdhuman.json' --output-root '../demos/abl'

...
python train.py mot --exp_id ch_dla34_whe0 --gpus $CUDA_VISIBLE_DEVICES --resume \
--batch_size 32 --load_model '../models/ctdet_coco_dla_2x.pth' --num_epochs 100 \
--lr_step '800' --lr 0.015 --data_cfg '../src/lib/cfg/crowdhuman.json' --dense_wh --wh_weight 5.0
cd ..

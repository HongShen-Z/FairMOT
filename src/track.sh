...
conda deactivate
conda activate fair
python track.py mot --test_mot15 True --load_model ../exp/mot15_ft_mix_ITP-MMD/models/model_last.pth \
--conf_thres 0.3 --gpus $CUDA_VISIBLE_DEVICES --exp_id MOT15_giou_ITP-MMD --output-root '../demos/benchmark'

...
conda deactivate
conda activate fair
python track_half.py mot --val_mot17 True --load_model ../exp/ablation_wh1/models/model_last.pth \
--conf_thres 0.4 --gpus $CUDA_VISIBLE_DEVICES --exp_id MOT17_abl_wh1
python TrackEval/scripts/run_mot_challenge.py --TRACKERS_TO_EVAL 'MOT17_abl_wh1' --BENCHMARK 'MOT17' \

...
conda deactivate
conda activate fair
python track_half.py mot --val_mot17 True --load_model ../exp/net/ch_fix_ITP-MMD/models/model_last.pth \
--conf_thres 0.4 --gpus $CUDA_VISIBLE_DEVICES --exp_id MOT17_ch_fix_ITP-MMD --output-root '../demos/abl/net'
python TrackEval/scripts/run_mot_challenge.py --TRACKERS_TO_EVAL 'MOT17_ch_fix_ITP-MMD' --BENCHMARK 'MOT17' \

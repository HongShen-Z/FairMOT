...
conda deactivate
conda activate fair
python track.py mot --test_mot20 True --load_model ../exp/mix_ft_ch_ITP-MMD-MOT20/models/model_last.pth \
--conf_thres 0.3 --gpus $CUDA_VISIBLE_DEVICES --exp_id MOT20_giou_ITP-MMD --output-root '../demos/benchmark'
#python TrackEval/scripts/run_mot_challenge.py --TRACKERS_TO_EVAL 'MOT17_giou_ITP-MMD' --BENCHMARK 'MOT17' \
